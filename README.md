...
- [**Databricks_EndtoEnd_DataVisualization**](https://github.com/Yam-ghub/Databricks_Practice/blob/main/README.md) - This project is an end-to-end data pipeline built in Databricks, covering data ingestion, transformation, analysis, and visualization. It focuses on United Nations emissions data, providing actionable insights into global and regional emission patterns. The project demonstrates the full lifecycle of a data engineering and analytics workflow, from raw data ingestion to interactive visualizations.
